...
export class AuthService {
  ...
  getRoleFromToken(){
    ...
    console.log('Get Role From Token', this.userPayload.role)
  }

  getUserNameFromToken(){
  if(this.userPayload)
  return this.userPayload.username;
  console.log('Get User Name From Token', this.userPayload.username)
  }
  ...
  getTeamMemberIdFromToken(): number | null {
    if (this.userPayload) {
      console.log(this.userPayload.teamMemberId)
